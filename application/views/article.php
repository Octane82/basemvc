...
<p>
    ...
    Ссылаясь на отчеты ретейлеров, он сообщил, что по этому показателю консоли следующего поколения превзошли PS3 и Xbox 360 вдвое.
</p>
...
<span style="color: dodgerblue">Включить переменную--:<br /> <?php foreach($vars as $item): ?></span>
                                                        <?php echo $item.'<br />'; ?>
                                                        <?php endforeach; ?>
